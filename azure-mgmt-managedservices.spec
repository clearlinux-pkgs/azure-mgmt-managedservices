...
License  : MIT
Requires: azure-mgmt-managedservices-python = %{version}-%{release}
Requires: azure-mgmt-managedservices-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-managedservices package.
Group: Default
Requires: azure-mgmt-managedservices-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-managedservices package.


%package python3
Summary: python3 components for the azure-mgmt-managedservices package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_managedservices)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-managedservices package.


%prep
%setup -q -n azure-mgmt-managedservices-1.0.0
cd %{_builddir}/azure-mgmt-managedservices-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588792156
